...
config :siemens_collection, PhonesCollectionWeb.Endpoint,
  http: [port: 4000],
  url: [host: "phonescollection.club", port: 80],
...
# start per endpoint:
#
#     config :siemens_collection, SiemensCollection.Endpoint, server: true
#
# You will also need to set the application root to `.` in order
# for the new static assets to be served after a hot upgrade:
#
#     config :siemens_collection, SiemensCollection.Endpoint, root: "."
