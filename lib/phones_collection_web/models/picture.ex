defmodule PhonesCollectionWeb.Picture do
  use SiemensCollection.Web, :model
  use Arc.Ecto.Schema

  alias PhonesCollectionWeb.{Picture, Repo}

  schema "pictures" do
    field :url, :string
    belongs_to :phone_edition, PhonesCollectionWeb.PhoneEdition
    belongs_to :item, PhonesCollectionWeb.Item
    # field :image, PhonesCollectionWeb.Image.Type
  ...
  #     :ok = PhonesCollectionWeb.Image.delete({picture.image.file_name, picture})
  #   end
  #   changeset
  # end
  ...
  def get_url(picture, version \\ :original) do
    cond do
      ...
      picture.image != nil -> PhonesCollectionWeb.Image.url({picture.image, picture}, version)
